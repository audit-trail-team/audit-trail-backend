...
async function resolveBody(req, body) {
    ...
    if (req.method === "POST" && req.url.endsWith("/get-audit-log-for-customer")) {
        ...
        json_response = serverError()
        try {
            if (jsonbody["EvidenceUserID"] === undefined ||
                jsonbody["PdfDocumentBase64"] === undefined ||
                jsonbody["Customer"] === undefined ||
                jsonbody["Timestamp"] === undefined ||
                jsonbody["SigType"] === undefined || jsonbody["SigType"] < 0 || jsonbody["SigType"] > 4) {
                return {
                    status: 400,
                    message: "missing required fields or incorrect type: EvidenceUserID, PdfDocumentBase64, Customer, Timestamp, SigType"
                }
            }
        ...
        try {
            for (const auditLog of jsonbody["auditLogs"]) {
                if (jsonbody["EvidenceUserID"] === undefined || jsonbody["EvidenceUserID"] instanceof string === false ||
                    ...
                    jsonbody["Timestamp"] === undefined || jsonbody["Timestamp"] instanceof number === false ||
                    jsonbody["SigType"] === undefined || jsonbody["SigType"] < 0 || jsonbody["SigType"] > 4) {
                    return {
                        status: 400,
                        message: "missing required fields or incorrect type: EvidenceUserID, PdfDocumentBase64, Customer, Timestamp, SigType"
