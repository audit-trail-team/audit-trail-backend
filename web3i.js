...
const privkey = require('./key.json');
...
function createEnv(providerUrl, contractAddr, abi) {
    ...
    const account = web3.eth.accounts.privateKeyToAccount(privkey.privkey);
...
async function contr_getCustomerName(providerUrl, contractAddr, abi)
{
...
module.exports = { contr_getCustomerName, contr_addAuditLog, contr_getAuditLog };